...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
<div class="article">
  <h2><span class="pages"><span class="style12">Welcome Wearable Device ::</span><%=application.getAttribute("dname")%> </span></h2>
  <p class="infopost">&nbsp;</p>
  <div class="clr"></div>
  <div class="img"><img src="images/img1.jpg" width="213" height="285" alt="" class="fl" /></div>
