    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/gal1.jpg" width="212" height="288" alt="" class="fl" /></div>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><strong><a href="c_CloudMain.jsp">Home</a></strong></li>
			 ...
			 <li><a href="c_View_All_Datasets_By_Group_Location.jsp">View All Datasets By Group Location Based Services</a></li>
			 
			 <li><a href="c_Infectious_Disease_Analysis_Request_Details.jsp">View Infectious Disease Analysis Request Details</a></li>
