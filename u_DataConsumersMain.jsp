      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><strong><a href="u_Find_Disease_Details.jsp">Find Disease Details</a></strong></li>
			<li><strong><a href="u_Infectious_Disease_Analysis_req.jsp">Request Infectious Disease Analysis</a></strong></li>
			<li><strong><a href="u_Infectious_Disease_Analysis_Request.jsp">View Requested Infectious Disease Analysis</a></strong></li>
