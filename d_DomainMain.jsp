...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
		  <li class="active"><a href="d_DomainMain.jsp">Trusted Authority</a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome :: Trusted Authority </span></h2>
          <p>&nbsp;</p>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu style10">
            <li><a href="d_DomainMain.jsp">Home</a></li>
			 ...
			 <li><a href="ta_Infectious_Disease_Analysis_Request.jsp">View Infectious Disease Analysis Request</a></li>
