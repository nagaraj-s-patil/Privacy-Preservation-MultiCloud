...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View All Uploaded Datasets !!! </span></h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <p> 
		  
		<iframe width="800" height="700" src="o_View_All_Datasets1.jsp"></iframe>
		  
          </p>
          <div align="right"><a href="o_DataOwnerMain.jsp">Back</a></div>
          <p>&nbsp;</p>
        </div>
      </div>
      <div class="clr"></div>
