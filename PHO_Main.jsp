...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
		  <li class="active"><a href="PHO_Main.jsp">PHO</a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome :: PHO</span></h2>
          <p>&nbsp;</p>
          <div class="img"><img src="images/img1.jpg" width="217" height="292" alt="" class="fl" /></div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style10">
			...
			<li><a href="PHO_View_All_Infectious_Disease_Analysis.jsp">Analyze and View All Infectious Disease Analysis Results</a></li>
			
			<li><a href="PHO_View_All_Infectious_Disease_Location_Results.jsp">Analyze and View All Infectious Disease Location Results</a></li>
