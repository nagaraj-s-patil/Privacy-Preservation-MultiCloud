...
<head>
<title>ta_Infectious_Disease_Analysis_Request1</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
          <h2 class="style5">View Infectious Disease Analysis Requests !!!</h2>
          <p>&nbsp;</p>
  	...
  	try 
	{
		...
		%>
                <td><div class="style21 style6 style7">
                    <div align="center"><a href="ta_Infectious_Disease_Analysis_Request1.jsp?usid=<%=i%>"><%=s4%></a></div>
                </div></td>
                <%
...
%>
            ...
            <p>&nbsp;</p>
            <p align="center"><a href="d_DomainMain.jsp">Back</a></p>
            <h2></h2>
    </div>
      <div class="clr">
        <p>&nbsp;</p>
