...
<head>
<title>PHO_View_All_Infectious_Disease_Location_Results</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style6">Privacy Preservation in Multi Cloud Secure Data Fusion for Infectious Disease Analysis</a></h1>
      </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View All Infectious Disease Location Results !!! </span></h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <p> 
		  
		<iframe width="800" height="450" src="Result1.jsp"></iframe>
		  
          </p>
          <div align="right"><a href="PHO_Main.jsp">Back</a></div>
          <p>&nbsp;</p>
        </div>
      </div>
      <div class="clr"></div>
