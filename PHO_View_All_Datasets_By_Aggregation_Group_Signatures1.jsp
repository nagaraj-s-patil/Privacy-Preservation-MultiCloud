          ...
          <div class="clr"></div>
           <%
						...
						// Creation Of Blockchain 
						 ...
						 String s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,s14,s15,s16,s17,s18,s19,s20,s21,s22,s23,s24,s25,s26,s27,s28,hsign,s111;
...
<td  width="72" height="45"  valign="middle" bgcolor="#FFFF00" ><div align="center" class="style1 style12 style11"><strong>Hashcode</strong></strong></div></td>
         ...
         <h3 align="center">
<p align="center" class="style12"><span class="style2">Infectious Liver Disease Analysis By Aggregation Group Signatures--->::</span> <%=s111%><br>
			    <span class="style12">Infectious Liver Disease Analysis Aggregation Group Signature --->::</span><%=hsign%></p>
	     </h3>
			<div align="center">
			  <%
